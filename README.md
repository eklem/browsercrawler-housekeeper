...
Housekeeping for search-index indexing / crawling in the browser aka [`browsercrawler`](https://github.com/eklem/browsercrawler). Keeping track of what has been added to search engine / database, and comparing to page timestamps.
